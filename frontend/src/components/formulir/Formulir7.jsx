    ...
    return (
      ...
      `}</style>
            ...
            <div className="form-header text-center mb-6">
                <h1 className="text-xl font-bold uppercase">DAFTAR ARSIP INAKTIF (FOTO)</h1>
            </div>
            ...
            <table className="form-table w-full text-xs">
                <thead>
                    <tr>
                        ...
                        <th>Uraian Informasi Foto</th>
                        <th className="w-20">Kurun Waktu</th>
                        <th className="w-24">Ukuran/ Warna</th>
                        <th className="w-20">Negatif/ Positif</th>
                        <th className="w-16">Jumlah</th>
                        <th className="w-32">Lokasi Simpan <br />(Boks/Amplop)</th>
            ...
            <div className="text-right text-xs mt-4 italic">
                Formulir 7. Daftar Arsip Inaktif (Foto)
            </div>
        </div>
    );
};

export default Formulir7;
