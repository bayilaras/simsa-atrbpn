    ...
    return (
      ...
      `}</style>
            ...
            <div className="form-header text-center mb-6">
                <h1 className="text-xl font-bold uppercase">DAFTAR ARSIP INAKTIF (SOUND RECORDING)</h1>
            </div>
            ...
            <table className="form-table w-full text-xs">
                <thead>
                    <tr>
                        ...
                        <th>Uraian Informasi Rekaman</th>
                        <th className="w-20">Kurun Waktu</th>
                        <th className="w-24">Jenis Media <br />(Kaset/CD/dll)</th>
            ...
            <div className="text-right text-xs mt-4 italic">
                Formulir 8. Daftar Arsip Inaktif (Sound Recording)
            </div>
        </div>
    );
};

export default Formulir8;
