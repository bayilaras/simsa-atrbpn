    ...
    return (
      ...
      `}</style>
            ...
            <div className="form-header text-center mb-6">
                <h1 className="text-xl font-bold uppercase">DAFTAR ARSIP INAKTIF (KERTAS)</h1>
            </div>
            ...
            <table className="form-table w-full text-xs">
                <thead>
                    <tr>
                        ...
                        <th className="w-20">Tingkat Perkembangan</th>
                        <th className="w-16">Jumlah</th>
                        <th className="w-32">Lokasi Simpan <br />(Rak/Boks/Folder)</th>
                        <th className="w-24">Keamanan & Akses</th>
                        <th className="w-24">Jangka Simpan & Nasib Akhir</th>
                        <th className="w-24">Kategori Arsip</th>
