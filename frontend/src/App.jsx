...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "/distribusi", element: <DistributionInbox /> },
      ...
      { path: "/archive-lending", element: <ArchiveLending /> },
      { path: "/dosir", element: <Dosir /> },
      { path: "/dosir/:id", element: <DosirDetail /> },
      { path: "/retention", element: <RetentionManagement /> },
      { path: "/penyusutan", element: <PenyusutanArsip /> },
      { path: "/arsip-vital", element: <ArsipVital /> },
      { path: "/arsip-terjaga", element: <ArsipTerjaga /> },
      { path: "/arsip-elektronik", element: <ArsipElektronik /> },
      { path: "/tunjuk-silang", element: <TunjukSilang /> },
      { path: "/autentikasi", element: <AutentikasiIndex /> },
      { path: "/autentikasi/create", element: <AutentikasiCreate /> },
      { path: "/formulir", element: <FormulirIndex /> },
      { path: "/layanan-arsip", element: <LayananArsipIndex /> },
      { path: "/layanan-arsip/create", element: <LayananArsipCreate /> },
      { path: "/layanan-arsip/:id", element: <LayananArsipDetail /> },
    ],
  },
  {
    element: (
