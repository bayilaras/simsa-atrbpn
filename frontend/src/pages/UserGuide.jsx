...
const GUIDE_SECTIONS = [
    ...
    },
    {
        ...
        steps: [
            ...
            'Administrator dan auditor dapat membuka Audit Log untuk menelusuri aktivitas yang tercatat.',
        ...
        actionByRole: {
            auditor: { label: 'Buka Audit Log', to: '/audit-log' },
            super_admin: { label: 'Buka Audit Log', to: '/audit-log' },
            admin_dirjen: { label: 'Buka Audit Log', to: '/audit-log' },
            admin_sesditjen: { label: 'Buka Audit Log', to: '/audit-log' },
