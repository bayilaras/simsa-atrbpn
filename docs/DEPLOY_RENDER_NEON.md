...
Gunakan Node.js 24 dan dependency backend/frontend dari lockfile proyek. Buat proyek Neon Free baru, PostgreSQL 16–18 (18 dianjurkan agar sama dengan pengujian), lalu database khusus yang kosong, misalnya `simsa_cloud`. Jangan memilih database lokal, database milik aplikasi lain, atau proyek Neon yang sudah mempunyai peran `simsa_*`. Bootstrap sengaja menolak target tersebut.
