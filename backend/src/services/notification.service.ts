...
export class NotificationService {
     ...
     */
    async getPendingSuratMasuk(unitKerjaId: string, userId: string): Promise<Notification[]> {
     ...
     */
    async getExpiringArchives(unitKerjaId: string, userId: string, daysAhead: number = 90): Promise<Notification[]> {
        const currentDate = new Date();
     ...
     */
    async getAllNotifications(unitKerjaId: string, userId: string, limit: number = 20): Promise<{
     ...
     */
    async getNotificationCount(unitKerjaId: string, userId: string): Promise<{
        total: number;
        urgent: number;
        warning: number;
        suratMasuk: number;
